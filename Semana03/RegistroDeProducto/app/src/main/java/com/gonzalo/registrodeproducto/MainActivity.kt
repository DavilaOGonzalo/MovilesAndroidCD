package com.gonzalo.registrodeproducto
...
import com.gonzalo.registrodeproducto.ui.theme.RegistroDeProductoTheme
...
fun PantallaRegistro(modifier: Modifier = Modifier) {
    ...
    Column(
        ...
        // Card de resumen condicionada al estado mostrarResumen
        if (mostrarResumen) {
